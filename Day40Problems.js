console.log("-----------------------Welcome to the AddressBook------------------");
...
addContact("Shubham","Mishra","b","kudur","Karnataka",561101,7259924438,"pavithraveeresh@gmail.com");
addContact("Tom","Ben","NewYork","NewYorkCity","NewYork",567890, 8908798989,"Tom@gmail.com");
addContact("Max","Baba","Mumbai","Mumbai City","Maharashtra",111111,9999999999,"Max@gmail.com");
addContact("Ram","Char","Electronic City","Bangalore","Karnataka",222222,7894561230,"Ram@yahoo.com");
addContact("Amte","Pande","North Zone","Chandrapur","Maharashtra",440025,1234567890,"Amte@gmail.com");
...
addContact("Deepak","Yadav","Shinde Nagar","Amravati","Maharashtra",440021,9874563210,"deepak@gmail.com");
...
addContact("Shub","Pande","North Zone","Chandrapur","Maharashtra",440025,1234567890,"shub@gmail.com");
